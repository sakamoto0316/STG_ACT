...
CResult::CResult()
{
	...
	if (CManager::GetSetScoreResult() == true)
	{
...
HRESULT CResult::Init(void)
{
	...
	CManager::GetSound()->PlaySoundA(CSound::SOUND_LABEL_BGM_RESULT);
...
void CResult::Update(void)
{
	...
	if (CManager::GetInputKeyboard()->GetTrigger(DIK_RETURN) == true ||
		CManager::GetInputJoyPad()->GetTrigger(CInputJoypad::BUTTON_A, 0) == true ||
		CManager::GetInputJoyPad()->GetTrigger(CInputJoypad::BUTTON_B, 0) == true)
	{
		switch (m_AddScoreCount)
		{
		case 0:
